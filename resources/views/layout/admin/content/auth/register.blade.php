                ...
                <div class="row border rounded-5 p-3 bg-white shadow box-area">
                    ...
                    <div class="col-md-6 right-box">
                        <div class="row align-items-center">
                            ...
                            <form action="{{ route('register.save') }}" method="POST" class="form">
                                @csrf
                                <div class="mb-1">
                                    <label for="fullname" >User Name : </label>
                                    <input type="text" name="name" class="form-control bg-light" placeholder="User Name..." >

                                    @error('name')
                                        <span class="text-danger error">* {{ $message }}</span>
                                    @enderror
                                </div>
                                <!-- <div class="text-danger mt-1">* Error Full Name</div> -->
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control bg-light " placeholder="Confirm Password..." >
                                </div>
                                ...
                                <div class="row">
                                    <small>Already Register? <a href="{{ url('/login') }}"> Login</a></small>
                                </div>
                            </form>

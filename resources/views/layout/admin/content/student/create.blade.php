...
@section('content')
    <main>
        ...
        <div class="recent-activity">
            <h2 class="activity-title">Add New Student
            ...
            <form action="{{ route('student.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select id="selectDegree" class="form-select @error('degree_id') is-invalid @enderror">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select id="selectMajor" class="form-select" disabled>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select id="selectStudyTime" class="form-select" disabled>
                        <option value="" selected disabled>Select Study Time</option>
                    </select>
                </div>

                {{-- Hidden degree_id (AJAX step 4) --}}
                <input type="hidden" name="degree_id" id="degreeId" value="{{ old('degree_id') }}">
                @error('degree_id')
                    <div class="col-md-12">
                        <span class="text-danger">* {{ $message }}</span>
                    </div>
...
@section('other_script')
    ...
    <script>
        ...
        $('#selectDegree').on('change', function () {
            ...
            $('#selectMajor').html('<option value="" selected disabled>Select Major</option>').prop('disabled', true);
            $('#selectStudyTime').html('<option value="" selected disabled>Select Study Time</option>').prop('disabled', true);
            $('#degreeId').val('');

...
@section('content')
    <main>
        ...
        <div class="recent-activity">
            <h2 class="activity-title">Add New Degree
            ...
            <form action="{{ route('degree.store') }}" method="POST" class="row g-3">
                @csrf
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select name="duration_years"
                        ...
                        <option value="" disabled {{ old('duration_years') ? '' : 'selected' }}>Select Year</option>
                        <option value="1 year"   {{ old('duration_years') === '1 year'   ? 'selected' : '' }}>ឆ្នាំទី ១</option>
                        <option value="2 years"  {{ old('duration_years') === '2 years'  ? 'selected' : '' }}>ឆ្នាំទី ២</option>
                        <option value="4 years"  {{ old('duration_years') === '4 years'  ? 'selected' : '' }}>ឆ្នាំទី ៤</option>
                        <option value="4.5 years"{{ old('duration_years') === '4.5 years'? 'selected' : '' }}>ឆ្នាំទី ៤.៥</option>
                    </select>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select name="study_time"
                        ...
                        <option value="" disabled {{ old('study_time') ? '' : 'selected' }}>Select Time</option>
                        <option value="monday-friday(day)"   {{ old('study_time') === 'monday-friday(day)'   ? 'selected' : '' }}>Monday–Friday (Day)</option>
                        <option value="monday-friday(night)" {{ old('study_time') === 'monday-friday(night)' ? 'selected' : '' }}>Monday–Friday (Night)</option>
                        <option value="saturday-sunday"      {{ old('study_time') === 'saturday-sunday'      ? 'selected' : '' }}>Saturday–Sunday</option>
                        <option value="sunday"               {{ old('study_time') === 'sunday'               ? 'selected' : '' }}>Sunday</option>
                    </select>
                    @error('study_time')
                        <span class="text-danger">* {{ $message }}</span>
                    @enderror
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select name="degree_level"
                        ...
                        <option value="" disabled {{ old('degree_level') ? '' : 'selected' }}>Select Level</option>
                        ...
                        <option value="technical" {{ old('degree_level') === 'technical' ? 'selected' : '' }}>Technical</option>
                    </select>
                    @error('degree_level')
                        <span class="text-danger">* {{ $message }}</span>
                    @enderror
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select name="generation"
                        ...
                        <option value="" disabled {{ old('generation') ? '' : 'selected' }}>Select Generation</option>
                        @foreach (range(1, 12) as $g)
                            ...
                            @endphp
                            <option value="{{ $val }}" {{ old('generation') === $val ? 'selected' : '' }}>
                                {{ $khmer }}
                            </option>
                        @endforeach
                    </select>
